    ...
    "search_params": {
        ...
        "augment": {
            "parameters": {
                **{
                    key: {"value": value}
                    for key, value in global_config.global_config.get("augment").items()
                },
...
effnet_surface_high_blur_sweep_params = {
    ...
    **default_params,
    ...
    "search_params": {
        ...
        # "learning_rate": {"values": [0.0003, 0.0007]},
        "learning_rate": {
            "values": [0.0003, 0.0001653, 0.0006]
        },  # 0.0001653 used for first high blur experiment
...
road_scenery_focus_params = {
    ...
    **default_params,
    ...
    "selected_classes": {
        ...
        "2_1_no_focus_no_street": ["2_1_all"],
    },
    "save_state": True,
    "avg_pool": 4,
}
...
resnet_test_params = {
    ...
    **default_params,
    ...
    "gpu_kernel": 0,
    "selected_classes": {"0IfiGAYF2WsqtEThMSXZxy": [], "0NPtbVg6hzw2QZlvKO9XoI": []},
    "save_state": True,
}
