...
def train_lightning_model(num_epochs, train_loader, valid_loader):
    ...
    with mlflow.start_run() as run:
        mlflow.log_params({"num_epochs": num_epochs, "learning_rate": model.learning_rate})
...
train_lightning_model(num_epochs=4, train_loader=train_loader, valid_loader=valid_loader)
