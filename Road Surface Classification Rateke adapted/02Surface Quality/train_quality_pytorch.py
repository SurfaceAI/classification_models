...
for index, quality_label in enumerate(quality_label_list):
    ...
    max_index = max_indeces[index] #maximum index we want to read, here we have 4 classes
    ...
    def train(num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            wandb.log({"avg train loss": avg_train_loss, "average validation loss": avg_val_loss, "average validation accuracy": avg_accuracy})
