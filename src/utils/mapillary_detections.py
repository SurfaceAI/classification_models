...
from src.utils.road_types import road_types, RoadTypes
from src.utils import mapillary_requests
...
def draw_bounding_box(draw: ImageDraw, box: tuple[int, int, int, int], color):
    # box: (x_left, y_top, height, width)
    pass

def draw_label(image, position, size, text):
    pass